...
const sendDefaultError = (res) => {res.status(DEFAULT_ERROR_CODE).send({ message: DEFAULT_ERROR_MESSAGE })}
...
module.exports = {DATA_NOT_FOUND_ERROR_CODE, DEFAULT_ERROR_CODE, DATA_NOT_FOUND_MESSAGE, DEFAULT_ERROR_MESSAGE, sendDefaultError, sendBadRequestError, sendNotFoundError}